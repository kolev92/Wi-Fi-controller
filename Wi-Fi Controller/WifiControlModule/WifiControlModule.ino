#include <ESP8266WiFi.h> //добавяне на нужните библиотеки
#include <DHT.h>
#include <Wire.h>
#include <LiquidCrystal_I2C.h>

LiquidCrystal_I2C lcd(0x3F, 16, 2); //създаване на обект lcd

byte celsius[8] = { //масив съдържащ символ градус целзии
  0b11000,
  0b11000,
  0b00000,
  0b00110,
...
const char* ssid = "Wemos"; //името и паролата намрежата, към която да се свържи контролера
const char* password = "12345678";

#define DHTPIN 13 //конфигуриране на сензора за температура и влажност на въздуха
...
void setup() {
  ...
  Serial.begin(115200);
  delay(10);
  //конфигуриране на входно/изходни портове
  pinMode(0, OUTPUT);  //D3 на ESP8266 D1 mini
  pinMode(2, OUTPUT);  //D4
  pinMode(12, OUTPUT); //D6
  pinMode(14, OUTPUT); //D5
  digitalWrite(0, HIGH);      // Сигналът на входа на релето се инвертира!
  digitalWrite(2, HIGH);
  ...
  WiFi.begin(ssid, password);
    //проверява свързан ли е контролерът към мрежа?
...
void loop() {
//прочитане на стойности за температура и влажност на въздуха
  humi = dht.readHumidity();
  temp = dht.readTemperature();
// визуализиране на информация на дисплея
  LcdLoopPrint();
